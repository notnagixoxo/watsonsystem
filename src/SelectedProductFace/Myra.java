 ...
 */
public class Myra extends javax.swing.JFrame {
    ...
    /* 
     This class represents the Myra id lace selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      Myra id lace details, select quantity, and manage their shopping cart.
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Microsoft YaHei UI", 1, 10)); // NOI18N
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/WATSONS LAYOUT (1).png"))); // NOI18N
        jLabel1.setText("SECA sc= new SECA();         sc.show();         dispose();");
    ...
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        ...
        SBMATable editCart = new SBMATable(cartModel);
    ...
    private void CheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckOutActionPerformed
        ...
        SBMAPayment pf = new SBMAPayment();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Myra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
