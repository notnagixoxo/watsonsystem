 ...
 */
public class Silka extends javax.swing.JFrame {
    ...
    /* 
    This class represents the Silka id lace selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      Silka id lace details, select quantity, and manage their shopping cart.
     */
    ...
    private void initComponents() {
        ...
        AddToCart2.setBackground(new java.awt.Color(255, 204, 51));
        AddToCart2.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        AddToCart2.setForeground(new java.awt.Color(153, 0, 51));
        AddToCart2.setText("ADD TO CART");
        AddToCart2.setMaximumSize(new java.awt.Dimension(85, 25));
        AddToCart2.setMinimumSize(new java.awt.Dimension(85, 25));
        AddToCart2.setPreferredSize(new java.awt.Dimension(85, 25));
        AddToCart2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AddToCart2ActionPerformed(evt);
            }
        });
        getContentPane().add(AddToCart2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 490, 100, 20));
        ...
        CheckOut2.setBackground(new java.awt.Color(0, 153, 153));
        CheckOut2.setFont(new java.awt.Font("Microsoft YaHei UI", 1, 10)); // NOI18N
        CheckOut2.setText("CHECK OUT");
        CheckOut2.setMaximumSize(new java.awt.Dimension(85, 25));
        CheckOut2.setMinimumSize(new java.awt.Dimension(85, 25));
        CheckOut2.setPreferredSize(new java.awt.Dimension(85, 25));
        CheckOut2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CheckOut2ActionPerformed(evt);
            }
        });
        getContentPane().add(CheckOut2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 520, 100, 20));
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/idlace/silkaf.png"))); // NOI18N
    ...
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        ...
        SASETable editCart = new SASETable(cartModel);
    ...
    private void CheckOut2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckOut2ActionPerformed
        ...
        SASEPayment pf = new SASEPayment();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Silka.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
