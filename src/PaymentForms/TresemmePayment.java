 ...
 */
public class TresemmePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public TresemmePayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TresemmePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TresemmePayment().setVisible(true);
            }
        });
    }
