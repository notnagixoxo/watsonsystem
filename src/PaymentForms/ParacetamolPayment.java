 ...
 */
public class ParacetamolPayment extends javax.swing.JFrame {

    
    public ParacetamolPayment() {
        initComponents();
...
// The event triggered when clicking the "Gcash" radio button.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParacetamolPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParacetamolPayment().setVisible(true);
            }
        });
    }
