 ...
 */
public class CEetaphilPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public CEetaphilPayment() {
        initComponents();
    ...
    /*
     This is the payment form for Cetaphil which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CEetaphilPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CEetaphilPayment().setVisible(true);
            }
        });
    }
