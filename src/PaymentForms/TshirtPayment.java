 ...
 */
public class TshirtPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public TshirtPayment() {
        initComponents();
    ...
    /*
     This is the payment form for Dove which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TshirtPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TshirtPayment().setVisible(true);
            }
        });
    }
