 ...
 */
public class SIlkaPayment extends javax.swing.JFrame {
    ...
    /*
     This is the payment form for Silka ID lace which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SIlkaPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SIlkaPayment().setVisible(true);
            }
        });
    }
