 ...
 */
public class NannyRosePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public NannyRosePayment() {
        initComponents();
   ...
   /*
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NannyRosePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NannyRosePayment().setVisible(true);
            }
        });
    }
