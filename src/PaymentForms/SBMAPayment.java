 ...
 */
public class SBMAPayment extends javax.swing.JFrame {
    ...
    /*
     This is the payment form for Myra ID lace which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SBMAPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SBMAPayment().setVisible(true);
            }
        });
    }
