 ...
 */
public class PsychologyPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public PsychologyPayment() {
        initComponents();
    ...
    /*
     This is the payment form for psychology uniform which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        HeadandShoulders bc = new HeadandShoulders();
        bc.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PsychologyPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PsychologyPayment().setVisible(true);
            }
        });
    }
