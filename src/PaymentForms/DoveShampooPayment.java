 ...
 */
public class DoveShampooPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public DoveShampooPayment() {
        initComponents();
    ...
    /*
     This is the payment form for Traditional Uniform which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    private void initComponents() {
        ...
        number1.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        number1.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jPanel2.add(number1, new org.netbeans.lib.awtextra.AbsoluteConstraints(248, 60, 131, -1));
        ...
        lblNumber1.setForeground(new java.awt.Color(255, 204, 51));
        lblNumber1.setText("Number:");
        jPanel2.add(lblNumber1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 40, -1, 20));
        ...
        jPanel2.add(lblError1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 90, 166, 16));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 414, 440));
    ...
    private void ConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmActionPerformed
        String contactNumber = number1.getText();

        if (contactNumber.isEmpty()) {
            lblError1.setText("Field cannot be empty!");
        } else if (!contactNumber.matches("\\d+")) { // Check if input is NOT a number
            lblError1.setText("Only numbers are allowed!");
        } else if (contactNumber.length() != 11) { // Check if not exactly 11 digits
            lblError1.setText("Number must be exactly 11 digits!");
        } else {
            ...
            if (gcash1.isSelected()) {
                ...
                lblError1.setText("Please select a payment method!");
    ...
    private void gcash1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gcash1ActionPerformed
        lblNumber1.setVisible(true);
        number1.setVisible(true);
        lblError1.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoveShampooPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoveShampooPayment().setVisible(true);
            }
        });
    }
