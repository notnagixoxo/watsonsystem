 ...
 */
public class AmlodipinePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public AmlodipinePayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmlodipinePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmlodipinePayment().setVisible(true);
            }
        });
    }
