 ...
 */
public class NeozepPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public NeozepPayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NeozepPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NeozepPayment().setVisible(true);
            }
        });
    }
