 ...
 */
public class SeoulWhitePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public SeoulWhitePayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeoulWhitePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeoulWhitePayment().setVisible(true);
            }
        });
    }
