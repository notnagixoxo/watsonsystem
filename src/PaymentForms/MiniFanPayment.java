 ...
 */
public class MiniFanPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public MiniFanPayment() {
        initComponents();
    ...
    /*
     This is the payment form for mini fan which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MiniFanPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MiniFanPayment().setVisible(true);
            }
        });
    }
