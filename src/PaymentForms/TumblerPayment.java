 ...
 */
public class TumblerPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public TumblerPayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TumblerPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TumblerPayment().setVisible(true);
            }
        });
    }
