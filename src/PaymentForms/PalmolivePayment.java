 ...
 */
public class PalmolivePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public PalmolivePayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PalmolivePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PalmolivePayment().setVisible(true);
            }
        });
    }
