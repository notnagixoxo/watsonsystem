 ...
 */
public class SafeGuardPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public SafeGuardPayment() {
        initComponents();
   ...
   /*
     This is the payment form for Stuff Toy which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SafeGuardPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SafeGuardPayment().setVisible(true);
            }
        });
    }
