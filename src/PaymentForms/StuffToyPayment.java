 ...
 */
public class StuffToyPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public StuffToyPayment() {
        initComponents();
   ...
   /*
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StuffToyPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StuffToyPayment().setVisible(true);
            }
        });
    }
