 ...
 */
public class DuffleBagPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public DuffleBagPayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DuffleBagPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DuffleBagPayment().setVisible(true);
            }
        });
    }
