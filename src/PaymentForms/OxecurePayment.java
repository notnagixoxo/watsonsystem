 ...
 */
public class OxecurePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public OxecurePayment() {
        initComponents();
   ...
   /*
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OxecurePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OxecurePayment().setVisible(true);
            }
        });
    }
