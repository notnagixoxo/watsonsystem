 ...
 */
public class VaselinePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public VaselinePayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VaselinePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VaselinePayment().setVisible(true);
            }
        });
    }
