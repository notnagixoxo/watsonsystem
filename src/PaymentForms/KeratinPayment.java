 ...
 */
public class KeratinPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public KeratinPayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KeratinPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KeratinPayment().setVisible(true);
            }
        });
    }
