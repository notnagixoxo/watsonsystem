 ...
 */
public class SHSPayment extends javax.swing.JFrame {
    ...
    /*
     This is the payment form for Vaseline ID lace which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SHSPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SHSPayment().setVisible(true);
            }
        });
    }
