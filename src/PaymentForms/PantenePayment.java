 ...
 */
public class PantenePayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public PantenePayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantenePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantenePayment().setVisible(true);
            }
        });
    }
