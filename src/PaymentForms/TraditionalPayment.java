 ...
 */
public class TraditionalPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public TraditionalPayment() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TraditionalPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TraditionalPayment().setVisible(true);
            }
        });
    }
