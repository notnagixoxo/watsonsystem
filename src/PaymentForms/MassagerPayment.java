 ...
 */
public class MassagerPayment extends javax.swing.JFrame {

    
    public MassagerPayment() {
        initComponents();
   ...
   /*
     This is the payment form for massager which allows users to choose their preferred payment method when completing a purchase.
     */
...
// The event triggered when clicking the "Cash on Delivery" radio button.
    private void cashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cashActionPerformed
        lblNumber.setVisible(true);
        number.setVisible(true);
        lblError.setVisible(true);
    }//GEN-LAST:event_cashActionPerformed
// The event triggered when clicking the "Gcash" radio button.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MassagerPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MassagerPayment().setVisible(true);
            }
        });
    }
