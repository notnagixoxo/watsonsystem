 ...
 */
public class HMSkirtPayment extends javax.swing.JFrame {

    /**
     * Creates new form PaymentForm
     */
    public HMSkirtPayment() {
        initComponents();
    ...
    /*
     This is the payment form for HM Skirt which allows users to choose their preferred payment method when completing a purchase.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HMSkirtPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HMSkirtPayment().setVisible(true);
            }
        });
    }
