...
public class Health extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tumbler.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/PAYB.png"))); // NOI18N
        ...
        Tshirt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/CENTRUM.png"))); // NOI18N
        ...
        Jacket.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/AMPLODIPINE.png"))); // NOI18N
        ...
        StuffToy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/NEOZEP (1).png"))); // NOI18N
        ...
        jLabel5.setText("Neozep");
        jLabel5.setOpaque(true);
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 660, 70, 20));

        jLabel4.setBackground(new java.awt.Color(0, 204, 204));
        jLabel4.setFont(new java.awt.Font("Sitka Small", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Centrum Advance");
        jLabel4.setOpaque(true);
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 430, 120, 20));
        ...
        jLabel6.setText("Paracetamol");
        jLabel6.setOpaque(true);
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 660, 90, 20));
