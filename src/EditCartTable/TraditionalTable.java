 ...
 */
public class TraditionalTable extends javax.swing.JFrame {
    ...
    public TraditionalTable(DefaultTableModel model) {
initComponents();
...
private void setupTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TraditionalTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TraditionalTable().setVisible(true);
            }
        });
    }
