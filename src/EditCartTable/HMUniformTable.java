 ...
 */
public class HMUniformTable extends javax.swing.JFrame {
     ...
     */
     public HMUniformTable() {
        initComponents();
      
    }
    public HMUniformTable(DefaultTableModel model) {
       initComponents();
...
private void setupTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HMUniformTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HMUniformTable().setVisible(true);
            }
        });
    }
