 ...
 */
public class TumblerTable extends javax.swing.JFrame {
    ...
    public TumblerTable(DefaultTableModel model) {
         initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Remove, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 470, -1, 20));
...
private void setupTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TumblerTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TumblerTable().setVisible(true);
            }
        });
    }
