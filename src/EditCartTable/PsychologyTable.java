 ...
 */
public class PsychologyTable extends javax.swing.JFrame {
     ...
     */
     public PsychologyTable() {
        initComponents();
      
    }
    public PsychologyTable(DefaultTableModel model) {
         initComponents();
...
private void setupTable() {
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
       HeadandShoulders tb = new HeadandShoulders();
       tb.show();
       dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PsychologyTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PsychologyTable().setVisible(true);
            }
        });
    }
