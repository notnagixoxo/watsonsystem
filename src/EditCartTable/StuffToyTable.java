 ...
 */
public class StuffToyTable extends javax.swing.JFrame {
     ...
     */
     public StuffToyTable() {
        initComponents();
      
    }
    public StuffToyTable(DefaultTableModel model) {
      initComponents();
...
private void setupTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StuffToyTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StuffToyTable().setVisible(true);
            }
        });
    }
