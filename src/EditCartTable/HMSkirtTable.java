 ...
 */
public class HMSkirtTable extends javax.swing.JFrame {
    ...
    public HMSkirtTable(DefaultTableModel model) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Remove, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 470, 100, 20));
...
private void setupTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HMSkirtTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HMSkirtTable().setVisible(true);
            }
        });
    }
