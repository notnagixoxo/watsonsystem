 ...
 */
public class TshirtTable extends javax.swing.JFrame {
    ...
    public TshirtTable(DefaultTableModel model) {
        initComponents();
...
private void setupTable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TshirtTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TshirtTable().setVisible(true);
            }
        });
    }
