...
import EditCartTable.HMUniformTable;
import Cart.CartManager;
import static Cart.CartManager.getCartModel;
import EditCartTable.PsychologyTable;
import MainForms.Shampoo;
import PaymentForms.PsychologyPayment;
 ...
 */
public class HeadandShoulders extends javax.swing.JFrame {
    ...
    /* 
     This class represents the Psychology Uniform selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      uniform details, select quantity, and manage their shopping cart.
     */
    ...
    private void initComponents() {
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SelectedProductShampoo/hnsf.png"))); // NOI18N
        ...
        lblName.setText("HEAD AND SHOULDERS");
        ...
        Back.setFont(new java.awt.Font("Microsoft YaHei", 1, 10)); // NOI18N
        Back.setText("BACK");
        ...
        EditCart.setFont(new java.awt.Font("Microsoft YaHei", 1, 10)); // NOI18N
        ...
        CheckOut.setFont(new java.awt.Font("Microsoft YaHei", 1, 10)); // NOI18N
    ...
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        ...
        PsychologyTable editCart = new PsychologyTable(cartModel);
    ...
    private void CheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckOutActionPerformed
        ...
        PsychologyPayment pf = new PsychologyPayment();
 ...
 String selectedGender = (String) genderComboBox.getSelectedItem(); // Get selected gender
    ...
    String imagePath = "/image/psychTopMale.png"; // Default to male
    if ("FEMALE".equals(selectedGender)) {
        imagePath = "/image/psychfemaletop.png"; // Change to female
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HeadandShoulders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HeadandShoulders().setVisible(true);
            }
        });
    }
