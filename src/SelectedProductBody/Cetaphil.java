 ...
 */
public class Cetaphil extends javax.swing.JFrame {
   ...
   /* 
     This class represents the Cetaphil selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      tumbler details, select quantity, and manage their shopping cart.
     */
    ...
    private void initComponents() {
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/merchandise/cetaphilf.png"))); // NOI18N
    ...
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        ...
        TumblerTable editCart = new TumblerTable(cartModel);
    ...
    private void CheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckOutActionPerformed
        ...
        TumblerPayment pf = new TumblerPayment();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cetaphil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
