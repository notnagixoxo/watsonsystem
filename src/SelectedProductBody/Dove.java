 ...
 */
public class Dove extends javax.swing.JFrame {
    ...
    /* 
     This class represents the Dove selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      tshirt details, select quantity, and manage their shopping cart.
     */
    ...
    private void initComponents() {
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/merchandise/dovercf.png"))); // NOI18N
    ...
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        ...
        dovesoap editCart = new dovesoap(cartModel);
    ...
    private void CheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckOutActionPerformed
        ...
        DovePayment pf = new DovePayment();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
