 ...
 */
public class SafeGuard extends javax.swing.JFrame {
    ...
    /* 
     This class represents the Stuff Toy selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      stuff toy details, select quantity, and manage their shopping cart.
     */
    ...
    private void initComponents() {
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/merchandise/sguardf.png"))); // NOI18N
    ...
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        ...
        StuffToyTable editCart = new StuffToyTable(cartModel);
    ...
    private void CheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckOutActionPerformed
        ...
        StuffToyPayment pf = new StuffToyPayment();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SafeGuard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
