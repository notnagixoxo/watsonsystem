...
public class Centrum extends javax.swing.JFrame {
    ...
    /*
      This class represents the Centrum selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      duffle bag details, select quantity, and manage their shopping cart.
     */
    ...
    private void initComponents() {
        ...
        lblName.setText("CENTRUM ADVANCE");
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/accessories/centrumf.png"))); // NOI18N
