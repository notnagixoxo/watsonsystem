...
import EditCartTable.neozep;
import Cart.CartManager;
import static Cart.CartManager.getCartModel;
import MainForms.HealthForm;
import PaymentForms.NeozepPayment;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;

/**
 *
 * Form for Mini Fan Selected Item Form
 */
public class Neozep extends javax.swing.JFrame {
    ...
    /* This class represents the Mini Fan selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      mini fan details, select quantity, and manage their shopping cart.
 ...
 // The event triggered when clicking the "Back" button. 
    ...
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        ...
        neozep editCart = new neozep(cartModel);
    ...
    private void CheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckOutActionPerformed
        ...
        NeozepPayment pf = new NeozepPayment();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Neozep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
