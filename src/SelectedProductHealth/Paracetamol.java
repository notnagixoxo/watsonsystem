...
public class Paracetamol extends javax.swing.JFrame {
    ...
    /* 
    This class represents the Paracetamol selection form in the Bulldogs
      Exchange Commerce system. It provides an interface for users to view
      massager details, select quantity, and manage their shopping cart.
     */
    ...
    // The event triggered when clicking the "Edit Cart" button.  
    private void EditCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCartActionPerformed
        DefaultTableModel cartModel = getCartModel(); // Retrieve the cart model

        if (cartModel.getRowCount() == 0) {
            JOptionPane.showMessageDialog(this, "Your cart is empty! Add items before editing.",
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        ...
        ac.show(); //Open Accessories Form
        dispose();
    }//GEN-LAST:event_BackActionPerformed
    // The event triggered when clicking the "Check Out" button.
    ...
    private void AddToCart1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddToCart1ActionPerformed
        ...
        try {
            // Retrieve selected quantity and price
